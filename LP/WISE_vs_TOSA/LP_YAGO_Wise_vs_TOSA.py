...
test_accuracy = [0.53,0.25]  # Dummy values for Test Accuracy
kg_tosa_pre_model_inf = [0.45]  # Teacher, Student
wise_pre_model_inf = [0.86]# Train, Prune, Re-train
train_memory_gkd = [0.55]  # Dummy values for Train Memory (Non-stacked)
train_memory_gcnp = [0.53]  # Dummy values for Train Memory (Non-stacked)

# Create figure and subplots
fig, axs = plt.subplots(1, 3, figsize=(8, 3))
width = 0.6
fig.suptitle('YAGO3-10 Airport-ConnectsTo', fontsize=16,y =0.95)
...
# Show the plot
# plt.show()
plt.savefig('/home/afandi/GitRepos/Bar_graphs/TRAINING_wise_v_prune/tosa_v_wise/LP_YAGO.pdf', dpi=1200, bbox_inches='tight',format='pdf')
